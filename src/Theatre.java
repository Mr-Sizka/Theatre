...
public class Theatre {
    public static void main(String[] args) {
        ...
        L1:do {
            ...
            switch (option) {
                case 0:
                    break L1;
                case 1: buy_ticket(theatre);break;
                case 2: print_seating_area(theatre);break;
                case 3: cancel_ticket(theatre);break;
    ...
    private static boolean checkSeat(int rowNumber, int seatNumber, int[][] theatre) {
      if(theatre[rowNumber-1][seatNumber-1]==0){
          return true;
      }else {
          return false;
      }
    }
    private static void confirmTicket(int rowNumber, int seatNumber, int[][] theatre) {
        Scanner input = new Scanner(System.in);
        while (true){
    ...
    private static void cancel_ticket(int[][] theatre) {
        Scanner input = new Scanner(System.in);
        int rowNumber = getRow();
        int seatNumber = getSeatNumber(rowNumber);
            do {
